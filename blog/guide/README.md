...
* **Image**   
شما میتونید هر Image فندقی رو معادل یک Image داکری تصور کنید.
...
**--port** یا **-p**        
از طریق این پارامتر مشخص می‌کنید می‌توانید کدام یک از پورت‌های سرویس مورد نظر خود را می‌خواهید در دسترس قرار دهید.در صورت عدم مشخص کردن پورت بخصوصی پورت ۸۰ Expose می‌شود.
