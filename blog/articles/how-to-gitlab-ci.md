...
سرویس gitlab-ci به طور کامل از طریق یک فایل کانفیگ به نام `.gitlab-ci.yml` و تنظیمات پنل گیتلب قابل کنترل و برنامه‌ریزی است که در مراحل آینده دقیق‌تر مورد بررسی قرار می‌گیرند.
